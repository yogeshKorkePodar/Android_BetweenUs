...
/**
 * Created by Gayatri on 2/16/2016.
 */
public class TeacherEnterMessageAdapter extends BaseAdapter {


    LayoutInflater layoutInflater;
    Context context;

    public ArrayList<com.podarbetweenus.Entity.AcedmicYearResult> AcedmicYearResult = new ArrayList<AcedmicYearResult>();
    public ArrayList<com.podarbetweenus.Entity.DivisionResult> DivisionResult = new ArrayList<DivisionResult>();
    public ArrayList<com.podarbetweenus.Entity.ShiftResult> ShiftResult = new ArrayList<ShiftResult>();
    public ArrayList<com.podarbetweenus.Entity.StandardResult> StandardResult = new ArrayList<StandardResult>();
    public ArrayList<SectionList> SectionList = new ArrayList<SectionList>();
    public TeacherEnterMessageAdapter(Context context, ArrayList<StandardResult> StandardResult,
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.rl_next.setBackgroundColor(Color.parseColor("#1282b9"));
        holder.ll_content.setBackgroundColor(Color.parseColor("#4ea3ce"));
        holder.ll_top.setBackgroundColor(Color.parseColor("#1282b9"));
        holder.rl_teacher_img.setBackgroundColor(Color.parseColor("#1282b9"));
        holder.view_vertical_line.setBackgroundColor(Color.parseColor("#1282b9"));
