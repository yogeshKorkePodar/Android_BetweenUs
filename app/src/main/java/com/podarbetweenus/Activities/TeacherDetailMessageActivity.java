...
/**
 * Created by Gayatri on 2/12/2016.
 */
public class TeacherDetailMessageActivity extends Activity implements View.OnClickListener{
    //Linear Layout
    ...
    private void getIntentData() {
        try {
            ...
            if(!(attachement_path.equalsIgnoreCase("") || attachement_path.equalsIgnoreCase("0"))){
    ...
    class DownloadFileFromURL extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String file_url) {
          ...
          //  dismissDialog(progress_bar_type);
            Toast.makeText(TeacherDetailMessageActivity.this,"Downloading Completed",Toast.LENGTH_SHORT).show();
        }
                ...
                if (resultCode == RESULT_OK) {
                    try {
                        ...
                        if (!attachedfilename.contains(".")) {
                            Toast.makeText(TeacherDetailMessageActivity.this, "Not valid file", Toast.LENGTH_LONG).show();
                        } else {
                        ...
                        //Upload File
                        if (length > 500) {
                            Toast.makeText(TeacherDetailMessageActivity.this, "File size is greater than 500KB", Toast.LENGTH_LONG).show();
                        } else if (!(extension.equalsIgnoreCase(".pdf") || extension.equalsIgnoreCase(".docx") || extension.equalsIgnoreCase(".doc"))) {
                            Toast.makeText(TeacherDetailMessageActivity.this, "Upload only Word or PDF Document", Toast.LENGTH_LONG).show();
                        } else {
    ...
    class TheTask extends AsyncTask<String,String,String>
    {
        ...
        protected void onPostExecute(String result) {
           ...
           /* Constant.showOkPopup(TeacherDetailMessageActivity.this, responseStatus, new DialogInterface.OnClickListener() {
            ...
            Toast.makeText(TeacherDetailMessageActivity.this,responseStatus,Toast.LENGTH_LONG).show();
    ...
    private void sendMessage() {
        ...
        if(message.equalsIgnoreCase("")){
            ...
            try {
                Log.d("<<FilenameReply",attachedfilename);
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            login_details = (LoginDetails) dft.GetResponseObject(response, LoginDetails.class);
                            if (login_details.Status.equalsIgnoreCase("1")) {
                                Constant.showOkPopup(TeacherDetailMessageActivity.this, login_details.StatusMsg, new DialogInterface.OnClickListener() {

                                    @Override
                                    public void onClick(DialogInterface dialog, int which) {

                                        Intent i = new Intent(TeacherDetailMessageActivity.this, TeacherMessageActivity.class);
                                        Intent intent = getIntent();
