...
/**
 * Created by Gayatri on 2/6/2016.
 */
public class BehaviourListActivity extends Activity implements View.OnClickListener{
    ...
    TeacherBehaviourAdapter teacher_behaviour_adapter;

    public String Loadmore="";
    int pageIndex=1,notificationID=1;
    int pageSize=200;
    boolean isLoading = false;
    String clt_id,usl_id,board_name,school_name,teacher_name,version_name,class_id,month_id,dropdownSelection="false",msd_id,org_id,clas_teacher,academic_year,teacher_shift,teacher_std,teacher_div;
    String ShowBehaviourMethod_name = "TeacherBehaviourStudList";
    String[] data_without_sibling;
    int[] icons_without_sibling;
    ArrayList<TeacherBehavioutStudResult> teacherBehavioutStudResult_loadmore = new ArrayList<TeacherBehavioutStudResult>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        requestWindowFeature(Window.FEATURE_NO_TITLE);
        setContentView(R.layout.teacher_behaviour_students_list);
    ...
    private void setDrawer() {
        try {
            if(LoginActivity.get_class_teacher(BehaviourListActivity.this).equalsIgnoreCase("1")){
                ...
                drawerListView.setAdapter(new CustomAccount(BehaviourListActivity.this, android.R.layout.simple_list_item_1, icons_without_sibling, data_without_sibling));
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (position == 0) {
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(BehaviourListActivity.this, TeacherProfileActivity.class);
                            ...
                            //Message
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(BehaviourListActivity.this, TeacherMessageActivity.class);
                                teacherProfile.putExtra("clt_id", clt_id);
                                teacherProfile.putExtra("usl_id", usl_id);
                                teacherProfile.putExtra("School_name", school_name);
                                teacherProfile.putExtra("Teacher_name", teacher_name);
                            ...
                            //SMS
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(BehaviourListActivity.this, TeacherSMSActivity.class);
                                teacherProfile.putExtra("clt_id", clt_id);
                                teacherProfile.putExtra("usl_id", usl_id);
                                teacherProfile.putExtra("School_name", school_name);
                                teacherProfile.putExtra("Teacher_name", teacher_name);
                            ...
                            //announcement
                            if (dft.isInternetOn() == true) {
                                Intent teacherannouncment = new Intent(BehaviourListActivity.this, TeacherAnnouncementsActivity.class);
                            ...
                            //Attendance
                            if (dft.isInternetOn() == true) {
                                Intent teacherattendance = new Intent(BehaviourListActivity.this, TeacherAttendanceActivity.class);
                            ...
                            //Behaviour
                            if (dft.isInternetOn() == true) {
                                Intent teacher_behaviour = new Intent(BehaviourListActivity.this, TeacherBehaviourActivity.class);
                            ...
                            //Sbject List
                            if (dft.isInternetOn() == true) {
                                Intent subject_list = new Intent(BehaviourListActivity.this, SubjectListActivity.class);
                            ...
                            Intent setting = new Intent(BehaviourListActivity.this, SettingActivity.class);
                            ...
                            //Signout
                            Intent signout = new Intent(BehaviourListActivity.this, LoginActivity.class);
                            Constant.SetLoginData("", "", BehaviourListActivity.this);
                            ...
                            try {
                                final Dialog alertDialog = new Dialog(BehaviourListActivity.this);
            ...
            Constant.setTeacherDrawerData(academic_year, teacher_name, teacher_div, teacher_std, teacher_shift, BehaviourListActivity.this);
            setDrawerData();
        }
        catch (Exception e){
            e.printStackTrace();
        ...
        dft.getBehaviourList(clt_id, class_id, pageIndex, pageSize, ShowBehaviourMethod_name, Request.Method.POST,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_details.Status.equalsIgnoreCase("1")) {
                                ...
                                tv_error_msg.setText("No Data Found");
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Log.d("BehaviourListActivity", "ERROR.._---" + error.getCause());
                    }
                });
    }
    ...
    private void setUIDataDataForList() {
        teacher_behaviour_adapter = new TeacherBehaviourAdapter(BehaviourListActivity.this, login_details.teacherBehavioutStudResult, clt_id, board_name, usl_id, version_name, teacher_name, school_name);
        lv_behaviour_selection_list.setAdapter(teacher_behaviour_adapter);
    }
    @Override
    public void onClick(View v) {
