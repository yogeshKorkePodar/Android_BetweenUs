...
import com.podarbetweenus.Adapter.ShowAttendanceAdapter;
 ...
 */
public class AttendanceListActivity extends Activity implements View.OnClickListener{
    ...
    //Edit Text
    EditText ed_select_date_for_attendance;
    //ImageView
    ...
    //ListView
    ListView drawerListView,lv_attendance_selection_list;
    //Image View
    ImageView img_close;
    //ProgressDialog
    ...
    ShowAttendanceAdapter show_attendance_adapter;

    String clt_id,usl_id,board_name,school_name,teacher_name,version_name,class_id,month_id,dropdownSelection="false",msd_id,org_id,clas_teacher,academic_year,teacher_shift,teacher_std,teacher_div,academic_year_Id;
    String DropDownMethod = "GetTeacherAttendanceDropDtls";
    ...
    public ArrayList<TeacherAttendaceResult> teacherAttendaceResult_loadMore = new ArrayList<TeacherAttendaceResult>();
    String[] select_month;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_attendance_list);
    ...
    private void findViews() {
        ...
        //Edit Text
        ed_select_date_for_attendance = (EditText) findViewById(R.id.ed_select_date_for_attendance);
        //ListView
    ...
    private void init() {
        header = new HeaderControler(this, true, false, "View Attendance");
        lay_back_investment.setOnClickListener(this);
        progressDialog = Constant.getProgressDialog(this);
        ed_select_date_for_attendance.setOnClickListener(this);
    ...
    private void setDrawer() {
        try {
            if(LoginActivity.get_class_teacher(AttendanceListActivity.this).equalsIgnoreCase("1")){
                ...
                drawerListView.setAdapter(new CustomAccount(AttendanceListActivity.this, android.R.layout.simple_list_item_1, icons_without_sibling, data_without_sibling));
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        if (position == 0) {
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(AttendanceListActivity.this, TeacherProfileActivity.class);
                            ...
                            //Message
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(AttendanceListActivity.this, TeacherMessageActivity.class);
                                teacherProfile.putExtra("clt_id", clt_id);
                                teacherProfile.putExtra("usl_id", usl_id);
                                teacherProfile.putExtra("School_name", school_name);
                                teacherProfile.putExtra("Teacher_name", teacher_name);
                            ...
                            //SMS
                            if (dft.isInternetOn() == true) {
                                Intent teacherProfile = new Intent(AttendanceListActivity.this, TeacherSMSActivity.class);
                                teacherProfile.putExtra("clt_id", clt_id);
                                teacherProfile.putExtra("usl_id", usl_id);
                                teacherProfile.putExtra("School_name", school_name);
                                teacherProfile.putExtra("Teacher_name", teacher_name);
                            ...
                            //announcement
                            if (dft.isInternetOn() == true) {
                                Intent teacherannouncment = new Intent(AttendanceListActivity.this, TeacherAnnouncementsActivity.class);
                            ...
                            //Attendance
                            if (dft.isInternetOn() == true) {
                                Intent teacherattendance = new Intent(AttendanceListActivity.this, TeacherAttendanceActivity.class);
                            ...
                            //Behaviour
                            if (dft.isInternetOn() == true) {
                                Intent teacher_behaviour = new Intent(AttendanceListActivity.this, TeacherBehaviourActivity.class);
                            ...
                            //Sbject List
                            if (dft.isInternetOn() == true) {
                                Intent subject_list = new Intent(AttendanceListActivity.this, SubjectListActivity.class);
                            ...
                            Intent setting = new Intent(AttendanceListActivity.this, SettingActivity.class);
                            ...
                            //Signout
                            Intent signout = new Intent(AttendanceListActivity.this, LoginActivity.class);
                            Constant.SetLoginData("", "", AttendanceListActivity.this);
                            ...
                            try {
                                final Dialog alertDialog = new Dialog(AttendanceListActivity.this);
            ...
            Constant.setTeacherDrawerData(academic_year, teacher_name, teacher_div, teacher_std, teacher_shift, AttendanceListActivity.this);
            setDrawerData();
        }
        catch (Exception e){
            e.printStackTrace();
    ...
    private void callDropdownWebservice(final String clt_id, final String usl_id,String board_name) {
        if(dft.isInternetOn()==true) {
        ...
        dft.getTeacherAttendanceDropdown(clt_id, usl_id, board_name, DropDownMethod, Request.Method.POST,
                        ...
                        try {
                            ...
                            if (login_details.Status.equalsIgnoreCase("1")) {
                                if (dropdownSelection.equalsIgnoreCase("false")) {
                                    ed_select_date_for_attendance.setText(login_details.MonthResult.get(0).monthyear);
                                    month_id = login_details.MonthResult.get(0).monthid;
                                    academic_year_Id = login_details.AcedmicYearResult.get(0).acy_id;
                                    //call webservice to show attendance
                                    try {
                                        showAttedanceList(clt_id, month_id, class_id, pageIndex, pageSize,usl_id,academic_year_Id);
                                    } catch (Exception e) {
                                        e.printStackTrace();
                                    }
                                }
                                try {
                                    for (int i = 0; i < login_details.MonthResult.size(); i++) {
                                        strings_month.add(login_details.MonthResult.get(i).monthyear);

                                        select_month = new String[strings_month.size()];
                                        select_month = strings_month.toArray(select_month);
    ...
    private void selectMonth( final String[] select_month) {
        ...
        alertDialog.setItems(select_month, new DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int item) {
                // Do something with the selection
                ed_select_date_for_attendance.setText(select_month[item]);
                dialog.dismiss();
                String selectedMonth = select_month[item];
                Log.e("Month", selectedMonth);
                month_id = getIDfromCountry(selectedMonth);
                Log.e("MonthId", month_id);
                pageSize = 200;
                pageIndex = 1;
                try {
                    //call webservice to show attendance
    ...
    private String getIDfromCountry(String selectedMonth) {

        String id = "0";
        for(int i=0;i<login_details.MonthResult.size();i++) {
            if(login_details.MonthResult.get(i).monthyear.equalsIgnoreCase(selectedMonth)){
                id= login_details.MonthResult.get(i).monthid;
            }

        }
        return id;
    }
    private void showAttedanceList(String clt_id,String month_id,String class_id,int pageIndex,int pageSize,String usl_id,String academic_year_Id) {
        if(dft.isInternetOn()==true) {
            if (!progressDialog.isShowing()) {
                progressDialog.show();
            }
        ...
        dft.getAttendanceList(clt_id, month_id, class_id, pageIndex, pageSize,usl_id,academic_year_Id, ShowAttendanceMethod_name, Request.Method.POST,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_details.Status.equalsIgnoreCase("1")) {
                                ...
                                AppController.teacherAttendaceResult = login_details.teacherAttendaceResult;
    ...
    private void setUIDataDataForList() {
        // creating object of Adapter and intialising variables using below constructor
        show_attendance_adapter = new ShowAttendanceAdapter(AttendanceListActivity.this,login_details.teacherAttendaceResult,academic_year_Id,clt_id);
        lv_attendance_selection_list.setAdapter(show_attendance_adapter);
    }

    @Override
    public void onClick(View v) {
        if(v==ed_select_date_for_attendance)
        {
            try {
                strings_month.clear();
  ...
  /*  private void callWebserviceToViewAttendance(String msd_id,String clt_id,String month_id) {
        if(dft.isInternetOn()==true) {
            if (!progressDialog.isShowing()) {
                progressDialog.show();z
            }
        }
        else{
            progressDialog.dismiss();
        }
        dft.getTeacherAttendanceListReason(msd_id, clt_id, month_id, ShowAttendanceReasonMethod_name, Request.Method.POST,
                new Response.Listener<JSONObject>() {
                    @Override
                    public void onResponse(JSONObject response) {
                        ...
                        try {
                            ...
                            if (login_details.Status.equalsIgnoreCase("1")) {
                                ...
                                try {
                                    ...
                                    LayoutInflater inflater = AttendanceListActivity.this.getLayoutInflater();
                                    alertDialog.requestWindowFeature(Window.FEATURE_NO_TITLE);
                                    alertDialog.getWindow().setBackgroundDrawable(
                                            new ColorDrawable(Color.TRANSPARENT));
                                    ...
                                    TeacherViewAttendanceAdapter teacher_attendnaceAdapter = new TeacherViewAttendanceAdapter(AttendanceListActivity.this, login_details.ViewStudAttendRes);
   ...
   /* @Override
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        if (!AppController.teacherAttendaceResult.get(position).total.equalsIgnoreCase("")) {
            msd_id = AppController.teacherAttendaceResult.get(position).msd_id;
            Log.e("ATTENDACE MSD", msd_id);
            //View Attendance with reason
            callWebserviceToViewAttendance(msd_id, clt_id, month_id);
        }
    }*/
}
