package com.podarbetweenus.components;

import android.graphics.Color;
import android.graphics.Paint;

import com.podarbetweenus.formatter.DefaultValueFormatter;
import com.podarbetweenus.formatter.DefaultYAxisValueFormatter;
import com.podarbetweenus.formatter.YAxisValueFormatter;
...
public class YAxis extends AxisBase {
    ...
    public enum YAxisLabelPosition {
        OUTSIDE_CHART, YAxisLabelPosition, INSIDE_CHART
    }
    ...
    public enum AxisDependency {
        LEFT, AxisDependency3, AxisDependency2, YAxis1, AxisDependency1, AxisDependency, YAxis, RIGHT
    }
