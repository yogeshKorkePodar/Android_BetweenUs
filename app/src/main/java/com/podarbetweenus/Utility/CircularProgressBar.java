...
public class CircularProgressBar extends View {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        try {
            // Value
            progress = typedArray.getFloat(com.mikhaellopez.circularprogressbar.R.styleable.CircularProgressBar_progress, progress);
            // StrokeWidth
            strokeWidth = typedArray.getDimension(com.mikhaellopez.circularprogressbar.R.styleable.CircularProgressBar_progressbar_width, strokeWidth);
            backgroundStrokeWidth = typedArray.getDimension(com.mikhaellopez.circularprogressbar.R.styleable.CircularProgressBar_background_progressbar_width, backgroundStrokeWidth);
            // Color
            color = typedArray.getInt(com.mikhaellopez.circularprogressbar.R.styleable.CircularProgressBar_progressbar_color, color);
            backgroundColor = typedArray.getInt(com.mikhaellopez.circularprogressbar.R.styleable.CircularProgressBar_background_progressbar_color, backgroundColor);
        } finally {
            typedArray.recycle();
        }
